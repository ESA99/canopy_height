...
## TODO
 ...
 - Create different kind of plots/visualization types for the results
    - play around with it
    - change axis
...
Location has a big impact on the prediction. - North-South gradient - Continentality - watch out for oceans when linking the projects or calculating lat long - specific lat/long values vs. difference to original location - method "comparison" -\> which is better for analysis/presentation
