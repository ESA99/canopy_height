...
# original_data <- "/home/emilio/canopy_height/results/2025-10-15_result_table_581112.csv"
...
custom_colors <- c( "Blue" = "dodgerblue2", "Green" = "chartreuse3", "Red" = "firebrick3",  "NIR" = "mediumpurple2",
                    "RedEdge" = "orange", "NIR2" = "navy", "SWIR1" = "#CC79A7", "SWIR2" = "#CC79F7")

# CBF = colorblind-friendly colour scale
cbf_colors <- c("Blue"  = "#0072B2","Green" = "#009E73", "Red"   = "#D55E00", "NIR"   = "#CC79A7" )

cbf_colors <- c("RedEdge"  = "#CC3311","NIR2" = "#CC79A7", "SWIR1"   = "#0077BB", "SWIR2"   = "#009988" )
