...
A <-read.csv("results/2026-01-19_result_table_interactions.csv")
head(A)
B <-read.csv("results/2026-01-24_result_table_interactions.csv")
head(B)
...
write.csv(merged, "results/2026-01-27_merged_Interactions.csv", row.names = F)
