...
tile_meta <- data.frame(
  tile = c("10TES","17SNB","20MMD","33NTG","32TMT",
           "32UQU","34UFD","35VML","49NHC","55HEV","49UCP"),

  location = c("USA East","USA West","Brazil","Cameroon","Switzerland",
               "Germany","Poland","Finland","Malaysia","Australia","Mongolia"),

  lon = c(-122.285282,-80.379497,-63.405779,12.786326,8.402194,
          12.430884,23.294500,26.091998,114.189928,147.613916,109.045451),

  lat = c(46.455086,37.449419,-1.400945,5.831657,47.355772,
          48.205131,52.730829,63.527175,2.213706,-36.636058,48.239885),
  ...
  col = rcartocolor::carto_pal(11, "Vivid"),

  col2 = c("#332288", "#6699CC", "#88CCEE", "#44AA99", "#117733", 
          "#999933", "#DDCC77", "#661100", "#CC6677", "#882255",  "#AA4499"),

  stringsAsFactors = FALSE
)
# data <- left_join(data, tile_meta, by = "tile")     # Add info to other df
# tile_meta |> dplyr::filter(tile == "55HEV")         # Filter Info
